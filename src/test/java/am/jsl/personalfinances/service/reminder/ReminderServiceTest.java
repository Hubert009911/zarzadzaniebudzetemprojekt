...
public class ReminderServiceTest extends BaseTest {
    ...
    /**
     * Wykonane przed wszystkimi testami ReminderServiceTest.
     *
    ...
    public void testCreateIncomeReminder() throws Exception {
        ...
        // Utwórz przypomnienie o automatycznym doładowaniu z datą z przeszłością
    ...
    public void testUpdateReminder() throws Exception {
        ...
        // Sprawdź poprawność przypomnienia
    ...
    /**
     * Tworzy nowe przypomnienie z podanymi polami.
     *
    ...
    /**
     * Wykonane po wszystkich testach ReminderServiceTest.
     *
     * @throws Exception w przypadku niepowodzenia
     */
    @AfterAll
