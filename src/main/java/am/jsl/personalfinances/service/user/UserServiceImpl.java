...
/**
 * Wdrożenie usługi {@link UserService}.
 */
@Service("userService")
...
public class UserServiceImpl extends BaseServiceImpl<User> implements UserService {
    ...
    public void resetPassword(PasswordResetDTO passwordResetDTO) throws InvalidTokenException {
        ...
        // Sprawdź, zmień token na wygasły
    ...
    public void register(User user, Locale locale, String contextPath) throws Exception {
        ...
        // Tworzenie tokenu weryfikacyjnegoCreate verification token
    ...
    /**
     * Setter dla właściwośći 'userDao'.
     *
     * @param userDao Wartość do ustawienia dla właściwości 'userDao'.
     */
    @Autowired
