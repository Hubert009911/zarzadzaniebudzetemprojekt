...
/**
 * Wdrożenie usługi {@link AccountService}.
 */
...
public class AccountServiceImpl extends BaseServiceImpl<Account> implements AccountService {
    ...
    /**
     * Plik szablonu, w którym jest przechowywana reprezentacja html kont.
     */
    ...
    /**
     * Setter dlaw właściwości 'accountDao'.
     *
     * @param accountDao Wartość do ustawienia dla właściwości 'accountDao'.
     */
    @Autowired
    ...
    /**
     * Generuje reprezentację html kont dla danego identyfikatora użytkownika.
