...
/**
 * Wdrożenie usługi {@link CategoryService}.
 */
...
public class CategoryServiceImpl extends BaseServiceImpl<Category> implements CategoryService {
    ...
    /**
     * Plik szablonu, w którym jest przechowywana reprezentacja html kategorii.
     */
    ...
    /**
     * Generuje reprezentację html kategorii dla danego identyfikatora użytkownika.
    ...
    /**
     * Setter dla właściwośći 'categoryDao'.
     *
     * @param categoryDao Wartość do ustawienia dla właściwości 'categoryDao'.
     */
    @Autowired
