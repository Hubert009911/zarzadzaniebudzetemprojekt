...
public class Constants {
    ...
    /**
     * Ścieżki zasobów statycznych generowane przez użytkownika.
     * Dla każdego użytkownika zostanie utworzony osobny folder o nazwie składającej się z identyfikatora użytkownika.
     */
